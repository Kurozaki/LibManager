...
const string _base64_encode_chars = 
    "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";

const WCHAR _base64_decode_chars[] = 
{
...
CString base64_encode(CString in_str)
{
    CString out_str;
    WCHAR c1, c2, c3;
    int i = 0;
...
CString base64_decode(CString in_str)
{
    CString out_str;
    WCHAR c1, c2, c3, c4;
    int i = 0;
    ...
    while ( i<len)
    {
        ...
        out_str += WCHAR( ((c2&0XF)<<4) | ((c3&0x3C)>>2) );
